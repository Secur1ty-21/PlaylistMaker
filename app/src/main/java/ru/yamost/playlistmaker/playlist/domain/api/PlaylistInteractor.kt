...
interface PlaylistInteractor {
    ...
    fun getPlaylistWithTracks(playlistId: Int): Flow<Result<PlaylistWithTracks>>
    ...
    fun updatePlaylist(playlistId: Int, name: String, description: String, uri: Uri?, size: Int)
}